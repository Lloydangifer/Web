(function() {	
	...
	/*			
	FP.addPage({titre: 'Opérateurs arithmétiques',
				resume: 'Les opérateurs arithmétiques, de concaténation et d\'incrément',
				rep: dossier,
				fic: 'php01c1', 
				chap: numChap});
	FP.addPage({titre: 'Opérateurs d\'assignement',
				resume: 'Les opérateurs d\'assignement et les opérateurs de bit.',
				rep: dossier,
				fic: 'php01c2', 
				chap: numChap});				
	FP.addPage({titre: 'Opérateurs de comparaison',
				resume: 'Les opérateurs de comparaison et les opérateurs logiques.',
				rep: dossier,
				fic: 'php01c3', 
				chap: numChap});
	FP.addPage({titre: 'Opérateurs de type',
				resume: 'Les opérateurs permettant de fixer un type, autres opérateurs',
				rep: dossier,
				fic: 'php01c4', 
				chap: numChap});				
	*/	
	...
	FP.addPage({titre: 'Instructions de boucles',
				...
				fic: 'php01d2',
				chap: numChap,
				exos: [['table_multiplication', 'Table de multiplications']]});
	...
	FP.addPage({titre: 'Valeurs de retour',
				...
				fic: 'php01e3',
				chap: numChap,
				exos: [ ['valeur_retour', 'Valeur de retour'] 
					]});
	...
	FP.addPage({titre: 'Inclure du code externe',
				...
				chap: numChap,
				exos: [
						['bibli_fonctions', 'Bibliothèque de fonctions']
					]});																													
	...
	FP.addPage({titre: 'Rechercher',
				...
				chap: numChap,
				exos: [
						['isAdresseMail', 'Tester une adresse e-mail']
						]});							
	...
	FP.addPage({titre: 'Indicés ou associatifs',
				resume: 'Créer directement des tableaux indicés ou associatifs.',
				rep: dossier,
				fic: 'php05a1',
				chap: numChap});
